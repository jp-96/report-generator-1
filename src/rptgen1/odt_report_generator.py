...
class ODTReportGenerator:
    def __init__(self, file_basename: str, convert_to_pdf: bool, pdf_filter_options: dict, uno_client_config: UnoClientConfig = UnoClientConfig()):
    ...
    def save_template_file(self, file: BinaryIO, filename: str):
        try:
            ...
            self.template_file_path = self._save_file(file, filename, self.template_dir_path)
    ...
    def render(self, context: dict) -> ReportGeneratorResult:
        try:
            ...
            odt_result_file_path = os.path.join(self.result_dir_path, rendered_file_basename + ".odt")
            ...
            if not self.convert_to_pdf:
                return ReportGeneratorResult(odt_result_file_path, "application/octet-stream", rendered_file_basename + ".odt")
            
            pdf_result_file_path = os.path.join(self.result_dir_path, rendered_file_basename + ".pdf")
            ...
            return ReportGeneratorResult(pdf_result_file_path, "application/pdf", rendered_file_basename + ".pdf")
